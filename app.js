...
const {getDept, addDept} = require('./public/lib/dept');
const {getEmployees, addEmployee, getManagers, updateRole} = require('./public/lib/employees');
const {getRoles, addRole} = require('./public/lib/roles')
